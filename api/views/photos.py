...
class ViewOnlyVideoListViewSet(ListViewSet):
    serializer_class = PhotoSummarySerializer
    pagination_class = HugeResultsSetPagination
    ...
    def list(self, *args, **kwargs):
        return super(ViewOnlyVideoListViewSet, self).list(*args, **kwargs)
    
class ViewOnlyPhotoListViewSet(ListViewSet):
    serializer_class = PhotoSummarySerializer
    pagination_class = HugeResultsSetPagination
    ...
    def list(self, *args, **kwargs):
        return super(ViewOnlyPhotoListViewSet, self).list(*args, **kwargs)