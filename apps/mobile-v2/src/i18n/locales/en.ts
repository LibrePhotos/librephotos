...
export const en = {
  ...
  backup: {
    ...
    blockerJobFailed: "Backup stopped: {{message}}. Tap “Retry failed” to try again.",
  ...
  sync: {
    ...
    // Job queue — "which stage is running, how far along, what is blocking it".
    queue: "Work queue",
    queueEmpty: "Nothing queued",
    queueIdle: "Queue empty — everything is up to date",
    queueDepth: "{{pending}} queued · {{running}} running · {{failed}} failed",
    queueRunning: "Running now: {{kind}}",
    queueWaiting: "Waiting to retry",
    queueFailures: "Problems",
    queueRetry: "Retry failed jobs",
    stages: "Pipeline",
    stageRemote: "Library from server",
    stageScan: "Camera roll scan",
    stageHash: "Preparing photos",
    stageUpload: "Uploading",
    stageThumbs: "Thumbnails",
    stageProgress: "{{done}} of {{total}}",
    stageNothing: "Nothing to do",
    stageStuck: "{{count}} stuck",
    jobKindOutboxReplay: "Pushing your changes",
    jobKindReseedCheck: "Checking settings",
    jobKindRemoteDelta: "Fetching library",
    jobKindDeviceScan: "Scanning camera roll",
    jobKindHashBatch: "Preparing photos",
    jobKindUploadAsset: "Uploading a photo",
    jobKindThumbPrefetch: "Caching thumbnails",
    jobKindIntegrityCheck: "Verifying the mirror",
  },
  offline: {
