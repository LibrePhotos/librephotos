...
The optional ``throttle`` setting spaces ORM queue tasks by a minimum number of
seconds per queue/cluster name, including entries defined through ``ALT_CLUSTERS``.
