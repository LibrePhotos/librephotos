...
const CpuInfoSchema = z.object({
  ...
  l3_cache_size: z.number(),
  l2_cache_size: z.string(),
  l1_data_cache_size: z.number(),
  l1_instruction_cache_size: z.number(),
  l2_cache_line_size: z.number(),
  l2_cache_associativity: z.number(),
});
